...
export function checkUnlockConditions(
  ...
  gameState: {
    ...
    stats: { totalClicks: number; upgradesPurchased: number };
    totalPassiveIncome: number;
    playerLevel: number;
    combo?: { currentStreak: number };
  }
): UnlockCheckResult {
  // ✅ TOUT TON CODE ACTUEL DE useUpgradeUnlock
...
// ✅ HOOK qui utilise la fonction pure
export const useUpgradeUnlock = (
  ...
  return useMemo(
    () => checkUnlockConditions(unlockConditions, gameState),
