 ...
 * Chaque upgrade coûte de la réputation et boost les revenus d'un ou plusieurs businesses
 */
...
export interface UpgradeConfig {
  ...
  multiplier: number; // ex: 1.1 = +10%, 1.2 = +20%
  affectedBusinesses: string[]; // IDs des businesses concernés
}
